<template>
    <view>
        ...
        >
            <cover-view
                style="position: absolute;bottom: 0;right: 0;color: red;"
            ><button @click="stopGetPosition">停止</button></cover-view>
        </map>
    </view>
</template>
        ...
        getCurrentPosition() {
            ...
            if (uni.getSystemInfoSync().platform === "android") {
                ...
                function wakeLock() {
                    ...
                    var PowerManager = plus.android.importClass(
                        "android.os.PowerManager"
                    );
                    var pm = main.getSystemService(Context.POWER_SERVICE);
                    g_wakelock = pm.newWakeLock(
